...
class Auxiliares extends Conexion{
    ...
    public function add($Nombre, $Apellido, $Documento, $Usuario, $Password, $Correo, $Seccion, 
        ...
        $statement = $this->db->prepare("INSERT INTO usuarios (NOMBRE, APELLIDO, PERFIL, DOCUMENTO, USUARIO, 
                                        ...
                                        VALUES(:Nombre, :Apellido, 'Auxiliar', :Documento, :Usuario, 
                                        :Password, :Correo, :Seccion, :Fecha_registro, :Estado)");
    ...
    public function get(){
        $rows = null;
        $statement = $this->db->prepare("SELECT * FROM usuarios WHERE PERFIL = 'Auxiliar'");
        $statement->execute();
    ...
    public function getById($Id){
        ...
        CORREO, SECCION, FECHA_REGISTRO, ESTADO FROM usuarios WHERE ID_USUARIO = :Id AND PERFIL = 'Auxiliar'");
